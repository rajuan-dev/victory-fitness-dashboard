...
function UserDetails() {
  ...
  const [usersData, setUsersData] = useState(globalDemoData.users);
  ...
  const confirmDelete = async () => {
    try {
      ...
      message.success("User deleted successfully (Demo)");
      setIsModalOpen(false);
      setSelectedUser(null);
    } catch (err) {
  ...
  const filteredData = useMemo(() => {
    ...
    return usersData.filter((r) =>
      [r.fullName, r.email, r.contactNumber, r.role, r.country]
        .filter(Boolean)
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-4 md:px-6 py-4 md:py-5 rounded-2xl mb-5 shadow-lg">
        <div className="flex flex-wrap md:flex-nowrap items-center gap-3 md:gap-4">
          ...
          <h1 className="text-white text-2xl sm:text-3xl font-bold">User Management</h1>
      ...
      >
        ...
        >
          <div className="flex flex-col justify-center items-center py-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-center text-slate-800 mb-3">Delete User</h1>
