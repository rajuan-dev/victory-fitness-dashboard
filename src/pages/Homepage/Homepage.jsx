...
export default function Homepage() {
  ...
  return <div className="space-y-6">
    <div className="flex flex-wrap items-center justify-between gap-3"><div><h1 className="text-2xl font-bold text-slate-800">Homepage Quotes</h1><p className="text-sm text-slate-500">Manage the quote rotation shown after the homepage greeting.</p></div><Button icon={<FiRefreshCw />} onClick={() => void load()} loading={loading}>Refresh</Button></div>
    <Tabs items={[{
